...
insert into DICTIONARY_TABLE_1(id, name, age, gender, about) VALUES(1, 'Alise', 20, 'female', 'tratata');
insert into DICTIONARY_TABLE_1(id, name, age, gender, about) VALUES(2, 'Bob', 19, 'male', 'ololo');
insert into DICTIONARY_TABLE_1(id, name, age, gender, about) VALUES(3, 'Jack', 21, 'male', 'blahblahblah');
insert into DICTIONARY_TABLE_1(id, name, age, gender, about) VALUES(4, 'Mike', 18, 'male', 'wow');
insert into DICTIONARY_TABLE_1(id, name, age, gender, about) VALUES(5, 'Kate', 20, 'female', 'jajaja');
